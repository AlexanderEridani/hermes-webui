...
def test_streaming_persists_context_fields_on_session_before_save():
    ...
    # Limit is 24000 after the cost/provenance pre-save persistence block was added.
    # This byte-distance assertion is brittle and must be bumped for legitimate
    # pre-save mutations; a structural block check would be more durable.
    assert save_call - block_start < 24000, (
